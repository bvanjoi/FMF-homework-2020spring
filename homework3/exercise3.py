...
# Hints:
#  You can reuse the all_set function that you've implemented in exercise 1
...
def seat_arrangement():
    ...
    bob_take_seat_1 = And(b1, Not(b2), Not(b3), Not(a1), Not(a1))
    ...
    carol_take_seat_1 = And(c1, Not(c2), Not(c3), Not(b1), Not(a1))
    carol_take_seat_2 = And(c2, Not(c1), Not(c3), Not(b2), Not(a2))
    carol_take_seat_3 = And(c3, Not(c1), Not(c2), Not(b3), Not(a3))
    ...
    alice_not_near_carol = And(Implies(b2, Not(a1)), Implies(b3, Not(a2)))
    solver.add(alice_not_near_carol)
